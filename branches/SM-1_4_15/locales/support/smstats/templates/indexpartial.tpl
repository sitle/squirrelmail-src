...
<h2>Partialy translated PO files for {TXT_REV} branch from {TXT_DATE}</h2>
...
<tr bgcolor="#e0e0e0">
  ...
  <td><font size="2"><b>partialy translated</b></font></td>
  <td><font size="2"><b>totaly untranslated</b></font></td>
</tr>
{TABLE}
</table>
</td></tr>
...
<br>
<b>Note:</b><br>
&nbsp;&nbsp;<b>1.</b> Partialy translated are PO files that have fuzzy and/or untranslated
strings.<br>
&nbsp;&nbsp;<b>2.</b> Totaly untranslated files count as POT files which yet have no PO files
associated. PO files that have no translated or fuzzy strings are added as totaly untranslated.<br>
&nbsp;&nbsp;<b>3.</b> PO files with errors and PO files whithout corresponding POT file are 
ignored.<br>
</font>
