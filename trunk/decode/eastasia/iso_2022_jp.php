 ...
 *
 * This script provides iso-2022-jp (rfc1468) decoding functions. Currently
 * implemented only jis0208 mapping.
 *
...
function charset_decode_iso_2022_jp ($string) {
    ...
    while ( $index < strlen($string)) {
        ...
        $ret .= get_iso_2022_jp_symbol($string,$index,$enc_table);
        $index=$index+get_iso_2022_jp_symbolsize($enc_table);
    }
    return $ret;
}

function get_iso_2022_jp_symbol($string,$index,$enc_table) {
...
function get_iso_2022_jp_symbolsize($enc_table) {
    switch ($enc_table) {
    case 'jis0208-1983':
        $symbolsize=2;
        break;
