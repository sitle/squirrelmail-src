...
// Rid of slashes if magic quotes are on.
 $sqspell_text=sqspell_csicop($sqspell_text);
 ...
 if ($errors){ 
  ...
  <head>
   ...
   <script type="text/javascript">
     ...
     for ($i=0; $i<sizeof($sqspell_lines); $i++){
       echo "sqspell_lines[$i] = \"" . trim(addslashes($sqspell_lines[$i])) . "\";\n";
     }
  ...
  <?php
  printf('<body bgcolor="%s" text="%s" link="%s" onload="populateSqspellForm()">', $color[4], $color[8], $color[7]);
   ?>
   ...
   <table border="0" width="100%">
    <tr align="center">
     <td colspan="4">
      <span style="background-color:<?php echo $color[5] ?>">Line with an error:</span><br>
      <textarea name="sqspell_line_area" cols="50" rows="3" wrap="hard" onfocus="this.blur()"></textarea>
     </td>
    </tr>
    <tr valign="middle">
     <td align="right" width="25%">
      <span style="background-color: <?php echo $color[5] ?>">Error:</span> 
     </td>
     <td align="left" width="25%">
      <input name="sqspell_error" size="10" value="" onfocus="this.blur()">
     </td>
     <td align="right" width="25%">
      <span style="background-color: <?php echo $color[5] ?>">Suggestions:</span> 
     </td>
     <td align="left" width="25%">
    ...
    <tr>
     <td align="right">
      <span style="background-color: <?php echo $color[5] ?>">Change to:</span> 
     </td>
     <td align="left">
     ...
     <td align="right">
      <span style="background-color: <?php echo $color[5] ?>">Occurs times:</span> 
     </td>
     <td align="left">
    ...
    <tr>
     <td colspan="4">
      <table border="0" cellpadding="0" cellspacing="3" width="100%">
       <tr align="center" bgcolor="<?php echo $color[5] ?>">
        <td>
