...
<table class="smdoc_table" style="width: 100%; margin-bottom:0px; padding-bottom: 0px;">
  <tr>
    <td class="col_left" style="width: 300px">
      <IFRAME src="/sqmdocs/li_smdoc.html" class="doc_elements" 
              name="left_bottom" id="left_bottom" onLoad="resizeMe(this)">
        <a href="/sqmdocs/index.html">View using regular frames</a>
      </IFRAME>
    </td>
    <td class="col_right">
      <IFRAME src="/sqmdocs/blank.html" class="doc_content"
