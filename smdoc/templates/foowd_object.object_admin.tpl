...
<tr><td class="label"><b><?php echo _("Title"); ?>:</b></td>
    <td class="value"><?php 
        echo $obj['title']->display();
        echo '&nbsp;[' . $object->objectid . ']';
    ?></td></tr>
<tr><td class="label"><b><?php echo _("Version"); ?>:</b></td>
    <td class="value"><?php echo $obj['version']->display(NULL, 10); ?></td></tr>
<tr><td class="label"><b><?php echo _("Class"); ?>:</b></td>
    <td class="value"><?php echo $obj['classid']->display(); ?></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td class="label"><b><?php echo _("Translation"); ?>:</b></td>
...
<?php foreach ( $obj['permissions'] as $method => $auth )
      { ?>
<tr><td class="label"><b><?php echo $method; ?>: </b></td>
